...
public class HttpNotificationPlugin implements NotificationPlugin {
    ...
    @PluginProperty(name = "url", title = "URL", description = "The URL to send the request to")
    private String url;

    @PluginProperty(name = "method", title = "HTTP Method", description = "The HTTP method to use (GET, POST, PUT, DELETE)")
    private String method;

    @PluginProperty(name = "body", title = "Request Body", description = "The body of the request (for POST and PUT)")
    private String body;

    @PluginProperty(name = "contentType", title = "Content Type", description = "The content type of the request")
